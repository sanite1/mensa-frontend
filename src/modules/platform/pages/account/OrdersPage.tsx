  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 lg:py-16">
      <header className="mb-8">
        ...
        <h1 className="mt-2 font-serif italic text-4xl text-(--ink)">Orders.</h1>
      </header>
    ...
    <li>
      ...
      >
        <div className="flex flex-wrap items-baseline justify-between gap-2">
          <div>
            <div className="text-[11px] uppercase tracking-[0.12em] text-(--mute) font-medium">
              {order.orderNumber}
            </div>
          ...
          <div className="text-right">
            ...
            <div className="text-[11px] uppercase tracking-[0.12em] text-(--mute) font-medium mt-1">
